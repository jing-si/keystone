...
<!-- key: id=key.standard.project.std-keystone-024 refs=key.topic.document-system key.topic.skill-contract -->
...
<!-- key: id=key.standard.project.std-keystone-032 refs=key.topic.skill-contract key.topic.formal-workflow key.role.subagent -->
### STD-KEYSTONE-032: 실행 역할은 lane, role, authority로 제한한다
