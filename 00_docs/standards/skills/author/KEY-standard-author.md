...
<!-- tags: author, 문서작성, 작업서생성, impact검토 -->
## 적용 범위
...
<!-- tags: author, 문서작성, output-contract -->
## Mode contract
