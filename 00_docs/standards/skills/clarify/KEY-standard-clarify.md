...
<!-- tags: clarify, 결정, 질문흐름, edit-plan -->
## 적용 범위
...
<!-- tags: clarify, impact검토, edit-plan -->
## Impact update
...
6. Superpowers 또는 외부 workflow를 automatic/must-use로 바꾸는 결과가 된다.
7. Implementation, schema, auth/security, generated/codegen, publishing decision이
   먼저 필요하다.

<!-- tags: clarify, 검증, edit-plan -->
## Verification
