...
1. `key-standard-artifact-graph.md`
   - 문서, decision, work, capability, code artifact, API, test artifact의 metadata,
     relation, locator, stale handling, impact candidate 기준을 정의한다.
...
3. Artifact graph 후보를 실제 변경으로 연결해야 하면 `../skills/linker/00_key-index.md`와
   `../skills/coordinator/00_key-index.md`를 함께 확인한다.
