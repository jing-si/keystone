...
<!-- key: id=key.standard.subagent.index.reading-rules refs=key.role.subagent key.doc.standard key.topic.work-execution -->
## 읽기 규칙

1. Subagent role이나 report status를 정의하거나 변경할 때는
