...
<!-- key: id=key.standard.project.out-of-scope refs=key.topic.skill-contract -->
## 적용하지 않는 범위
...
<!-- key: id=key.standard.project.terms refs=key.doc.source key.topic.document-system key.topic.skill-contract key.topic.key-prefix key.topic.bootstrap -->
## 표준 용어
...
<!-- key: id=key.standard.project.std-keystone-014 refs=key.topic.skill-contract -->
