...
| Author Standard | `00_docs/works/r001-bootstrap-keystone/author-standard/00_key-index.md` | ready | `keystone-author` 기준서와 작업서 생성 표준 |
...
현재 active round는 R001 Bootstrap Keystone이고, active work는 S03이다. S00 문서 트리
재정비, S01 전체 기준서, S02 reader 기준서는 accepted 상태다.
