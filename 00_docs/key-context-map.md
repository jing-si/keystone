...
현재 active round는 R001 Bootstrap Keystone이고, active work는 S06이다. S00 문서 트리
재정비, S01 전체 기준서, S02 reader 기준서, S03 author 기준서, S04 clarify 기준서,
S05 coordinator 기준서는 accepted 상태다.
