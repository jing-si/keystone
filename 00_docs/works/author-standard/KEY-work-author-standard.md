...
<!-- tags: author, 문서작성, 작업서생성, 목표 -->

## Goal

`keystone-author`의 문서 작성/수정 계약과 작업서 생성 표준을 정리한다.

<!-- tags: author, 범위, 기준서, 작업서, approval-boundary -->
...
<!-- tags: source-context, author, 기준서, 결정기록 -->
...
<!-- tags: acceptance, author, 작업서생성, 책임경계 -->
...
<!-- tags: context-pack, STD-KEYSTONE-029, DEC-WORKS-002, source-edit-gate -->
...
<!-- tags: stop-condition, approval-boundary, source-edit-gate, scope-control -->
...
<!-- tags: verification, author, git-diff-check, 기준서검증 -->
...
<!-- tags: output-contract, author, 작업서생성, 기준서 -->

## Expected Output

- 작업서 생성 표준이 포함된 Author 기준서

<!-- tags: review-point, author, approval-boundary, 작업순서 -->
...
<!-- tags: progress-update, main-acceptance, S03 -->
