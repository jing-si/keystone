...
| DEC-002 | S02 | Document paths are English. Default root is `00_docs/`; root resolution order is current user instruction, `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `agent.md`, then default. | Keep paths portable while respecting project instructions. | accepted |
